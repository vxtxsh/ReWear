    ...
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-gradient mb-4">ReWear</h3>
            <p className="text-gray-400 text-sm">
              Sustainable fashion exchange platform. Swap, share, and save the planet one outfit at a time.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/browse" className="text-gray-400 hover:text-white transition-colors">Browse Items</a></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} ReWear. All rights reserved. Made with 💚 for a sustainable future.</p>
        </div>
      </div>
    </footer>
  )
